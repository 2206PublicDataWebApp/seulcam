			...
			<div class="booking_info">
				...
				<div class="input_info row">
					...
					<div class="col-8 text-end" style="text-align: left;">
						...
						<p style="margin: auto; padding-right: 15px; font-size: 12px">${campBooking.totalDay}박 x <span class="sitePrice"></span></p>
					</div>
					<div class="col-4">
					...
					<div class="col-8 text-end" style="text-align: left;">
						<h7 style="margin: auto; padding-right: 15px;">-<span id="bookUsePoint">0</span></h7>
					</div>
					<div class="col-4">
