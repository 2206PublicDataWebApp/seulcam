					...
					<div class="detailMain">
						...
						<div class="booking_info">
							...
							<div class="input_info row" style="padding: 20px;">
								<div class="col-4">
									<h6 style="margin: auto; padding: auto;">이름 <span style="color: red;">(필수)</span>
									</h6>
								</div>
								<div class="col-8">
								...
								<div class="col-4">
									<h6 style="margin: auto; padding: auto;">연락처 <span style="color: red;">(필수)</span>
									</h6>
								</div>
								<div class="col-8">
							...
							<div class="input_info row">
								...
								<div class="col-9 text-end"
									...
									<input type="number" class="pointInput" name="" value="" id="pointInput"
										placeholder="">
									<div class="btnPoint" style="margin-bottom: 0;"><a onclick="pointCancle()">사용취소</a>
									</div>

								</div>
								<p align="right" class="nowPoint">사용가능 포인트 <span
										id="available-point">${mOne.totalPoint}</span>원</p>
								<hr>
							</div>
							<h5><b>결제 상세</b></h5>
							<div class="input_info row">
								...
								<div class="col-8 text-end" style="text-align: left;">
									...
									<p style="margin: auto; padding-right: 15px; font-size: 12px">${countDay}박 x <span
											class="sitePrice"></span></p>
								</div>
								<div class="col-4">
									<p class="peopleInfo">인원추가요금</p>
								</div>
								...
								<div class="col-8 text-end" style="text-align: left;">
									<h7 style="margin: auto; padding-right: 15px;">-<span id="bookUsePoint">0</span>원
									</h7>
								</div>
								<div class="col-4">
