...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/admin/campReviewList">
                    <i class="fas fa-fw fa-table"></i>
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                        	...
                                        	<td><a href="/camp/campDetail.kh?contentId=${campReview.campId}">${campReview.campName}</a></td>
                ...
                checked.each(function(i){
                 ...
                 $.ajax({
                    ...
                    success:function(data){
                        if(data=="success"){
                            alert("성공.");
                            location.replace("/campAdmin/campReviewList.kh");
                        }else{
                            alert("실패");
                        }
                    },error:function(){
