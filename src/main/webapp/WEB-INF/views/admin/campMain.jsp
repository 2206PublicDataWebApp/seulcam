                        ...
                        <div class="container-fluid">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    ...
                                    <a href="/campAdmin/campBlogInsert.kh">눌러보세요</a>
                                </div>
                                <div class="card-body">
                                        ...
                                        <div class="row" style="margin-top: 10px;">
                                            <div class="col-sm-3">
                                                <div class="dataTables_info" id="dataTable_info" role="status"
                                                    aria-live="polite">[검색갯수 : ${count} ]
                                                    <p>${sList.city} ${sList.category} ${sList.search} 검색결과</p>
                                                </div>
                                            </div>
                                            <div class="col-sm-9">
                                                <form action="/admin/camp/campList" method="get">
                                                    <div align="center">
                                                    ...
                                                    <tbody>
                                                        <c:forEach items="${cList }" var="campList" varStatus="i">
                                                            <tr align="center">
                                                                ...
                                                                <td><a
                                                                        href="/camp/campDetail.kh?contentId=${campList.contentId}">${campList.facltNm}</a>
                                                                </td>
                                                                ...
                                                                <td><a
                                                                        href="/admin/camp/siteList?contentId=${campList.contentId}">관리페이지</a>
                                                                </td>
                                                            </tr>
                                                        </c:forEach>
                                                    </tbody>
                                                    ...
                                                    <ul class="pagination" style="    display: flex; justify-content: flex-end;">
                                                        <c:if test="${currentPage == 1 }">
                                                            <li class="paginate_button page-item previous disabled"
                                                                ...
                                                                <a href="/admin/camp/campList?page=0&city=${sList.city}&category=${sList.category}&search=${sList.search}&regist=${sList.regist}"
                                                                    aria-controls="dataTable" data-dt-idx="0"
                                                                    tabindex="0" class="page-link">first</a>
                                                            </li>
                                                            <li class="paginate_button page-item previous disabled"
                                                                id="dataTable_previous">
                                                                <a href="/admin/camp/campList?page=${currentPage -2}&city=${sList.city}&category=${sList.category}&search=${sList.search}&regist=${sList.regist}"
                                                                    aria-controls="dataTable" data-dt-idx="0"
                                                        ...
                                                        <c:forEach var="p" begin="${startNavi }" end="${endNavi }">
                                                            ...
                                                            <c:if test="${currentPage ne p }">
                                                                <li class="paginate_button page-item">
                                                                    <a href="/admin/camp/campList?page=${p -1 }&city=${sList.city}&category=${sList.category}&search=${sList.search}&regist=${sList.regist}"
                                                                        aria-controls="dataTable" data-dt-idx="1"
                                                                        tabindex="0" class="page-link">${p }</a>
                                                                </li>
                                                            </c:if>
                                                        </c:forEach>
                                                        <c:if test="${maxPage > currentPage }">
                                                            <li class="paginate_button page-item next"
                                                                id="dataTable_next">
                                                                <a href="/admin/camp/campList?page=${currentPage }&city=${sList.city}&category=${sList.category}&search=${sList.search}&regist=${sList.regist}"
                                                                    aria-controls="dataTable" data-dt-idx="2"
                                                                    tabindex="0" class="page-link">></a>
                                                            </li>
                                                            <li class="paginate_button page-item next"
                                                                id="dataTable_next">
                                                                <a href="/admin/camp/campList?page=${maxPage-1}&city=${sList.city}&category=${sList.category}&search=${sList.search}&regist=${sList.regist}"
                                                                    aria-controls="dataTable" data-dt-idx="2"
