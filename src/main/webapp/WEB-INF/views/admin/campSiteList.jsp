                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                                        ...
                                                        <form action="/campAdmin/campAdminMain.kh" method="get">
                                                            <div align="right">
                                                                <div style="display: inline-block;">
                                                                    <a href="/campAdmin/campRegistAviCon.kh?contentId=${camp.contentId}"
                                                                        class="btn btn-secondary btn-sm">예약가능여부 변경</a>
                                                                </div>
                                                                <div style="display: inline-block;">
                                                                    <a href="/campAdmin/campAdminSiteRegist.kh?contentId=${camp.contentId}"
                                                                        class="btn btn-secondary btn-sm">캠핑장 사이트
                                                                        등록하기</a>
                                                                </div>
                                                            </div>
                                                        </form>
                                                    ...
                                                    <c:if test="${!empty stList }">
                                                        <c:forEach items="${stList }" var="campSiteList" varStatus="i">
                                                            <tr align="center">
                                                                ...
                                                                <td><a
                                                                        href="/camp/campDetail.kh?contentId=${campSiteList.campId}">${campSiteList.campName}</a>
                                                                </td>
                                                                <td><a class="siteInfo" data-bs-toggle='modal'
                                                                        data-bs-target='#exampleModal'
                                                                        onclick='modal(${campSiteList.siteNo})'>${campSiteList.siteName}</a>
                                                                </td>
                                                                <td>
                                                                    <fmt:formatNumber value="${campSiteList.sitePrice}"
                                                                        pattern="#,###" />원
                                                                </td>
                                                                <td>${campSiteList.standardPeople}명/${campSiteList.maxPeople}명
                                                                </td>
                                                                <td>${campSiteList.siteCount}개</td>
                                                                <td>-</td>
                                                                <td>
                                                                    <a onclick="modifySite(${campSiteList.siteNo})"
                                                                        class="btn btn-secondary btn-sm">수정</a> <a
                                                                        onclick="deleteSite(${campSiteList.siteNo},${campSiteList.campId})"
                                            ...
                                            <div>
                                                <a href="/admin/camp/campList"
                                                    class="btn btn-secondary btn-sm">리스트관리메인</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <script>
                    function deleteSite(siteNo, contentId) {
                        if (confirm("정말 삭제하시겠습니까?")) {
                            location.href = "/campAdmin/campSiteReUpdate.kh?siteNo=" + siteNo + "&contentId=" + contentId;
                        }
