                                       ...
                                       <c:forEach items="${cbList}" var="campBooking" varStatus="i">
                                        <c:set var="k" value="0" />
                                           <tr>
                                               ...
                                               <td><fmt:formatDate value="${campBooking.bookDate }" pattern="yyyy-MM-dd HH:mm"/></td>
                                               <td>${campBooking.campSite.campName}</td>
                                               <td>${campBooking.firstDay } ~ ${campBooking.lastDay }</td>
                                               <td><fmt:formatNumber value="${campBooking.bookTotalPrice }" pattern="#,###" />원</td>
                                            ...
                                            <c:forEach items="${opList}" var="pay" varStatus="p">
                                                <c:if test="${campBooking.bookingNo eq pay.orderNo }">
                                                        <c:if test="${campBooking.bookCancleStatus eq 'N' }">
                                                            <c:set var="k" value="1" />
                                                            <td>
                                                                ...
                                                                <button  class="btn btn-secondary btn-sm" onclick="cancelPay(this)">환불하기</button>
                                                            </td>
                                                        </c:if>
                                                        <c:if test="${campBooking.bookCancleStatus eq 'Y' }">
                                                            <c:set var="k" value="1" />
                                                            <td>환불완료</td>
                                                        </c:if>
                                                </c:if>
