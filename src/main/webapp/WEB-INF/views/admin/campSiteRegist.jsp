                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <form action="/campAdmin/campSiteInsert.kh" enctype="multipart/form-data"
                                            method="post">

                                            <div class="row">

                                                <div class="col-md-6">
                                                    <input type="hidden" class="form-control hidden" name="campId"
                                                        value="${camp.contentId}" readonly>
                                                    <div>
                                                        <label>캠핑장이름
                                                            <input type="text" class="form-control" name="campName"
                                                                value="${camp.facltNm}" readonly>
                                                        </label>
                                                    </div>
                                                    ...
                                                    <div>
                                                        ...
                                                        <div id="thumbnailzone">
                                                            <label for="thumbnail" class="form-label"> <img onerror=""
                                                                    src=""> <input type="file" name="uploadFile"
                                    ...
                                    <div style="text-align: center; margin-top: 10px;">
                                        <a href="/admin/camp/siteList?contentId=${camp.contentId}"
